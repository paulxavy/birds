window.addEventListener('DOMContentLoaded', () => {
  ...
  const boxes = [
    {
      top: ['s', 's'],
      text: 'desliza hacia arriba  <br /><span>(suavecito)</span>',
    },
    {
      top: ['m', 'm'],
      text: 'los pajaritos te acompañarán en el camino',
    },
    {
      top: ['m', 'm'],
      bottom: ['m'],
      text: 'sige subiendo, te esperan más arriba...',
    },
    {
      top: ['m', 'm'],
      bottom: ['m', 'm'],
    ...
    },
    {
      top: ['m', 's', 's', 's', 'm'],
      bottom: ['s', 's', 's'],
      text: "llegaste! <br/> <span>(te deseo que tengas un lindo día)</span>",
    },
  ]
  ...
  class Bird {
    ...
    tweet() {
      this.el.classList.add('Holaaaa')
      new SpeechBubble({
        bird: this,
        text: 'Holaaaa',
      })
      setTimeout(() => {
        this.el.classList.remove('Holaaaa')
        this.bubble?.remove()
      }, 1000)
    }
    twitch() {
